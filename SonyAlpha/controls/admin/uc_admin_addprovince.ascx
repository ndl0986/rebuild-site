<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="uc_admin_addprovince.ascx.vb" Inherits="SonyAlpha.uc_admin_addprovince" %>
<div class="navigations">
    <div class="breakcurm clearfix">
        <a class="button"><span class="icon icon4"></span></a>
        <span class="heading">Trung tâm Sony > Danh sách Tỉnh thành > Thêm tỉnh thành :<a class="button floatright" href="javascript:history.go(-1);"><span class="icon icon8"></span></a></span>
    </div>
</div>
<div class="content">
    <div class="section">
