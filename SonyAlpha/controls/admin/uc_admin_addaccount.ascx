    ...
    <div class="section">
        <ul class="form">
            <li class="row clerafix">
                ...
                <div class="item"><asp:TextBox runat="server" ID="txtUName" CssClass="textbox" required MaxLength="50" ></asp:TextBox></div>
            </li> 
            <li class="row clerafix">
                <div class="caption" >Mật khẩu :</div>
                <div class="item"><asp:TextBox runat="server" ID="txtPWD" CssClass="textbox" 
                        required MaxLength="50" TextMode="Password" ></asp:TextBox></div>
            </li> 
            <li class="row clerafix">
