<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="uc_admin_editproduct.ascx.vb" Inherits="SonyAlpha.uc_admin_editproduct" %>
<%@ Register assembly="FredCK.FCKeditorV2" namespace="FredCK.FCKeditorV2" tagprefix="FCKeditorV2" %>
<div class="navigations">
    <div class="breakcurm clearfix">
        <a class="button"><span class="icon icon4"></span></a><span class="heading">Hệ thống > Danh mục Sản phẩm > Cập nhật Sản phẩm : <a class="button floatright" href="javascript:history.go(-1);"><span class="icon icon8"></span></a></span>
    </div>
</div>
<div class="content">
    <div class="section">
        <ul class="form">
            ...
            <li class="row clerafix">
                ...
                <div class="item"><asp:TextBox runat="server" ID="txtCreated" CssClass="textbox" MaxLength="150" ReadOnly="true"></asp:TextBox></div>
            </li>
            <li class="row clerafix">
                <div class="caption" >Ngày cập nhật :</div>
                <div class="item"><asp:TextBox runat="server" ID="txtUpdated" CssClass="textbox" MaxLength="150" ReadOnly="true"></asp:TextBox></div>
            </li>
            <li class="row clerafix">
