...
<div class="content">
    ...
    <ul class="form">
        ...
        <li class="row clearfix">
            <div class="caption">TÊN ĐĂNG NHẬP : <%= user.UserName%></div>
        </li>
        <li class="row clearfix">
            <div class="caption">HỌ & TÊN : <%= user.fullname %></div>
        </li>
        <li class="row clearfix">
        ...
        <li class="row clearfix">
           ...
           <li class="row clearfix">
                <div class="item">
                    <img alt="sony_camera" src="/upload/sony_camera.png" />
                </div>
           </li>
        </li>
    </ul>
