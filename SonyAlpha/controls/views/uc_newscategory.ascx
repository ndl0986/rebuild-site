...
<div id="section_collection" class="clearfix">
    <%If listTop.Count > 0 Then%><ul class="list_collection clearfix">
        <% For Each row As News In listTop%><li>
            <div class="clearfix">
                <img src="<%=row.NewsImage%>" alt="" /><div class="title_banner_text">
...
<div class="news_cat_content">
    <%  If listNewsInCat.Count > 0 Then%>
    <ul class="list_news clearfix">
        <%  For Each row As News In listNewsInCat%>
        <li>
        ...
        <ul>
            ...
            <li>
                <a href="<%= pg.PageUrl %>" <% If pg.PageNum = pageNum Then %>style="color:Red;" <% Else %> style="color:Black" <% End If %>>
                    <%= pg.PageText %>
                </a>
            </li>
            <% Next %>
