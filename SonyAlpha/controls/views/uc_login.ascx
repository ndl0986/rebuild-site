...
<ul class="form frmSignIn">
    ...
    <li class="clearfix">
        <div class="item"> 
            Quên mật khẩu? <a href="javascript:void(0);" id="uc_login_forgot_pass">Click vào đây</a>
        </div>
    </li>    
    <li class="clearfix">
        <div class="item"> 
            Chưa có tài khoản? <a href="javascript:void(0);" id="uc_login_goregister">Vui lòng đăng ký</a>
        </div>
    </li>
    <li class="clerafix">
